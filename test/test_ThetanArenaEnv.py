...
class ThetanArenaEnvTestCase(unittest.TestCase):
	...
	def test__keyboard_input(self):
		...
		[
			...
			'w', 'x', 'y', 'z', '{', '|', '}', '~', 'altleft', 'altright', 'backspace',
			'capslock', 'ctrlleft', 'ctrlright', 'delete', 'divide', 'down', 'end',
			'enter', 'esc', 'escape', 'f1', 'f10', 'f11', 'f12', 'f13', 'f14', 'f15',
			'f16', 'f17', 'f18', 'f19', 'f2', 'f20', 'f21', 'f22', 'f23', 'f24', 'f3',
			'f4', 'f5', 'f6', 'f7', 'f8', 'f9', 'insert', 'left', 'multiply', 'num0',
			'num1', 'num2', 'num3', 'num4', 'num5', 'num6', 'num7', 'num8', 'num9',
			'numlock', 'pagedown', 'pageup', 'pause', 'right', 'shiftleft', 'shiftright',
			'space', 'stop', 'subtract', 'tab', 'up', 'command', 'optionleft', 'optionright'
		]
		```
		action_a = np.zeros((133));
		action_a[38] = 1;
		self.env._keyboard_input(action_a);
		action_ctrl_a = np.zeros((133));
		action_ctrl_a[38] = 1;
		action_ctrl_a[72] = 1;
		self.env._keyboard_input(action_ctrl_a);
